...
def upgrade() -> None:
    ...
    op.create_index('ix_analysis_scope_time', 'analysis_report', ['scope', sa.text('created_at DESC')], unique=False)
    op.create_table('defi_metric',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index('ix_news_published', 'news_article', [sa.text('published_at DESC')], unique=False)
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('symbol', 'exchange', 'timeframe', 'timestamp', name='uq_ohlcv')
    )
    op.create_index('ix_ohlcv_lookup', 'ohlcv_data', ['symbol', 'exchange', 'timeframe', sa.text('timestamp DESC')], unique=False)
